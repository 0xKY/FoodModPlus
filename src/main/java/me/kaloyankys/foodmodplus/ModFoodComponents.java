...
public class ModFoodComponents {
    ...
    public static final FoodComponent CHEESE = new FoodComponent.Builder().hunger(4).saturationModifier(4).build();
    public static final FoodComponent ICECREAM = new FoodComponent.Builder().hunger(10).saturationModifier(5).build();
}
